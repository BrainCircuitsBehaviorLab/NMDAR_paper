...
\fill[orange!80] (\xSessStart+0.6,\ySess) rectangle (\xSessStart+0.6+\boxW,\ySess-0.25);
...
\fill[cyan!70] (\xStimStart+0.6,\yStim) rectangle (\xStimStart+0.6+\boxW,\yStim-0.25);
...
\fill[violet!80] (\xHistStart+0.3,\yHist) rectangle (\xHistStart+0.3+\boxW,\yHist-0.25);
...
\foreach \i/\h in {0/0.3,1/0.5,2/0.25,3/0.6,4/0.35}{
    ...
    \draw[orange!80!black, line width=1.2pt] (\x,\ySess-0.2) -- (\x,\ySess-0.2+\h);
}

\foreach \i/\h in {0/0.2,1/0.4,2/0.7,3/1.0}{
    \pgfmathsetmacro{\x}{\xStimWStart + \boxStep*\i}
    \draw[cyan!60!black, line width=1.2pt] (\x,\yStim-0.2) -- (\x,\yStim-0.2+\h);
}

\foreach \i/\h in {0/1.0,1/0.7,2/0.4,3/0.2,4/0.1}{
    \pgfmathsetmacro{\x}{\xHistWStart + \boxStep*\i}
    \draw[violet!80!black, line width=1.2pt] (\x,\yHist-0.2) -- (\x,\yHist-0.2+\h);
}
...
(\xSessWStart+0.6-0.1,\ySess-0.3) rectangle (\xSessWStart+0.6+0.1,\ySess+0.15);
