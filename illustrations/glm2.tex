...
\begin{adjustbox}{
  ...
  \begin{tikzpicture}[
    ...
    % =====================================================
    % INTERMEDIATE ARROWS
    % S.E. and A now occupy the schematic column position
    % =====================================================
    ...
    % Regressor names at the schematic column
    \node[
      font=\Large
    ]
    at (\xRegC,\yStim)
    ...
    at (\xStimScheme-0.06,\yStimScheme+0.43)
    {S.E.};
    ...
    at (\xStimScheme+0.08,\yStimScheme-0.06)
    {DV};
